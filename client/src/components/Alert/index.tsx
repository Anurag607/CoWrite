  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <p className={"text-sm"}>Are you sure you want to delete this doc?</p>
        </div>
          ...
          <button
            onClick={async () => {
              ...
              try {
                ...
                toast.success("Document deleted successfully!", ToastConfig);
                setIsLoading(false);
                location.reload();
                return;
              } catch (error) {
            ...
            className={classNames({
              ...
              "bg-primary text-[#fafafa] text-sm": true,
